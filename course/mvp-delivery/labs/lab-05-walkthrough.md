...
![Tosca home dashboard after Okta SSO login — Run results, Recently edited, Test artifact creation, Scheduled runs widgets visible](lab-05-screenshots/ss01-tosca-home.png)
...
![Tosca Reports page — execution history, pass/fail breakdown, run metrics](lab-05-screenshots/ss06-reports.png)
...
![Tosca Playlists page — empty state with "Go to Playlists" and "Schedule playlist run" actions](lab-05-screenshots/ss05-playlists.png)
...
After building your playlist, click **Run** (▶) on the playlist row.
...
![Course site Lab 05 card — Test Automation and Quality Gates, Optional MVP Lab tier](lab-05-screenshots/ss08-course-site-lab5.png)
