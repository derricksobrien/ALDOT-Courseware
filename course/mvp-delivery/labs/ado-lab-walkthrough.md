...
![Team dashboard with Sprint Burndown, Query Tile, and Velocity widgets](ado-lab-screenshots/ss01-dashboard.png)
...
![Feature backlog showing Day 1 and Day 2 Epics with 8 features](ado-lab-screenshots/ss02-feature-backlog.png)
...
![Stories backlog with 8 User Stories spanning both sprints](ado-lab-screenshots/ss03-stories-backlog.png)
...
![Sprint 1 planning view showing stories assigned to Iteration 1](ado-lab-screenshots/ss05-sprint-planning.png)
...
![Sprint 1 task board with To Do / In Progress / Done columns](ado-lab-screenshots/ss04-sprint-taskboard.png)
...
![User Story detail view showing title, AC, story points, and iteration](ado-lab-screenshots/ss07-work-item-detail.png)
...
![Query results showing all 4 Sprint 1 User Stories with state, iteration, and story points](ado-lab-screenshots/ss06-query-results.png)
...
![Final dashboard showing Sprint Burndown, Sprint 1 Stories count tile, and Velocity chart](ado-lab-screenshots/ss08-dashboard-complete.png)
