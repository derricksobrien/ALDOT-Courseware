...
- `lab-10-capstone-scoreboard.html`

On the GitHub Pages site, this is the public scoring UI instructors can use during the showdown.
...
- `lab-10-capstone-sample-data.json`
...
- `lab-10-capstone-scorecard-template.json`
...
3. Open `lab-10-capstone-scoreboard.html`.
