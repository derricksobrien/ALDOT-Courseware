...
- A fork of the training repository in your own GitHub account.
- Secrets configured for cloud login and registry.

## Step-by-Step
1. Fork the repository to your own GitHub account and use that fork as the workflow target.
...
7. Add failure notifications and rollback procedure (stretch goal).
